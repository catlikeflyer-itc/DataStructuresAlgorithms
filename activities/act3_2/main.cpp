...
// Búsqueda secuencial
int busquedaSecuencial( vector<Registry> d, bool (*condition)(Registry r) ){
...
int busquedaSecuencial( vector<Registry> d, bool (*condition)(Registry a, Registry b), Registry r ){
    for (int i = 0; i<d.size(); i++){
